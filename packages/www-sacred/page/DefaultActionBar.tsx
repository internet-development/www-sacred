...
import { toggleDebugGrid } from '@srcl/ui/DebugGrid';
...
export const findFocusableParent = (element: Element | null): Element | null => {
  while (element) {
...
export const findNextFocusableSibling = (element: Element, direction: 'next' | 'previous'): HTMLElement | null => {
...
export const findNextFocusableAncestor = (element: Element, direction: 'next' | 'previous'): HTMLElement | null => {
